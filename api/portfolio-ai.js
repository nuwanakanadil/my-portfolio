...
function buildSystemPrompt() {
  return [
    ...
    'Manual and private projects are shown with screenshots, descriptions, and case-study details where available. Code can be discussed on request.',
    '',
    'Portfolio data:',
    'Name: Nuwanaka Nadil',
    ...
    '- BidMaster: Selected public full-stack academic project, online auction system, PHP, MySQL, HTML, CSS, JavaScript',
    '- PDF-Site: Selected public web app, TypeScript-based project focused on PDF-related web features',
    '- 2YS2: Selected public JavaScript learning project focused on frontend and scripting practice',
    '- Demo: Selected public TypeScript experiment for learning and iteration',
    'Links:',
